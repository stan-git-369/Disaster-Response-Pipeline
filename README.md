...
2. Screenshot 2: Overview of training dataset

![Overview of training dataset](https://github.com/stan-git-369/Disaster-Response-Pipeline/blob/main/disaster-response-project_overview.png)
